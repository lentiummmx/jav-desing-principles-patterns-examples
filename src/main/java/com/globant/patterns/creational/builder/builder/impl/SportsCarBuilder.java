package com.globant.patterns.creational.builder.builder.impl;
...
public class SportsCarBuilder implements CarBuilder {
    ...
    public void buildBreaks() {
        car.setBreaks("Four-wheel disc brakes: two ventilated. Electronic brake distribution. StabilityTrack stability control");
    }
