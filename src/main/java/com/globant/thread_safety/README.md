...
While another one might hold an _array_ of _strings_:
...
A _ReadWriteLock_ lock actually uses a pair of associated locks, one for read-only operations and other for writing operations.
